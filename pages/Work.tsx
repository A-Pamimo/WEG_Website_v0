...
export const Work: React.FC = () => {
   ...
   if (selectedStudy) {
      return (
         <div className="min-h-screen bg-white text-weg-navy pt-24 pb-20 fade-in">
            <SEO title={selectedStudy.title} description={selectedStudy.summary} />
   ...
   return (
      <div className="min-h-screen bg-white pt-32 pb-20 px-6 md:px-12">
         <SEO title="Client Results" description="Explore our case studies to understand how we deliver defensible value across sectors." />
